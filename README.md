...
The user will always be alerted if errors occur, and referred to the log file as well as this README. (See LOGGING and EXCEPTIONS sections below.) Program executes gracefully in all events. 
